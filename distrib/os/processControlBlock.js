...
(function (TSOS) {
    class ProcessControlBlock {
        ...
        Anyway, segHash is my attempt at preventing illegal reads and writes. Since my memory is physically different from the implementation discussed in class
            ...
            So, before this, if a PCB segment was changed, nothing was preventing it from continuing execution.
        Now, when a PCB is created, it gets assigned a segment. To make sure there is no befuddlement, I then assign this segment to a one-time-write, readonly, private class
        ...
        */
        getSegHash() { return this.segHash; }
    }
